...
class DocumentApi(baseUrl: String) extends CirceSchema {
   ...
   * @param documentId DocumentId to delete
   */
   ...
   */
  def find(username: String, password: String, bearerToken: String, apiKey: String)(collectionName: String, mongoFindRequest: MongoFindRequest, rowsPerPage: Option[Long] = None, page: Option[Long] = None) =
    basicRequest
   ...
   * 
   * @param collectionName The name of your MongoDb Collection
   * @param documentId DocumentId to read
   */
   ...
   * 
   * @param collectionName The name of your MongoDb Collection
   * @param requestBody JSON Representation for your Document.
   */
   ...
   * 
   * @param collectionName The name of your MongoDb Collection
   * @param filter Lucene Query by  all filter. More Information: <a target=\"_blank\" href=\"https://mongodb-driver.mongocamp.dev/documentation/database/lucene.html\">Lucene Query</a>
   * @param sort Sorting by with an list of keys. Leading minus (-) means desc.
   ...
   * 
   * @param collectionName The name of your MongoDb Collection
   * @param documentId DocumentId to update
   * @param requestBody 
   */
  def update(username: String, password: String, bearerToken: String, apiKey: String)(collectionName: String, documentId: String, requestBody: Map[String, Any]) =
    basicRequest
   ...
   * @param requestBody 
   */
  def updateDocumentPartial(username: String, password: String, bearerToken: String, apiKey: String)(collectionName: String, documentId: String, requestBody: Map[String, Any]) =
    basicRequest
