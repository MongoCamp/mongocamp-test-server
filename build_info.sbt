...
buildInfoPackage := "dev.mongocamp.server.test"
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/MongoCamp/mongocamp-test-server"),
    "scm:https://github.com/MongoCamp/mongocamp-test-server.git"
  )
)
